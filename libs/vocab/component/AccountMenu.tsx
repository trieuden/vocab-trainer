...
export const AccountMenu = ({ isOpenAccMenu, setIsOpenAccMenu, isShortcutKeys, setIsShortcutKeys }: AccountMenuModalProps) => {
      ...
      <Stack direction="column" alignItems="center" spacing={2} className={`overflow-y-auto ${isMobile && 'h-[400px]'}`}>
        ...
        <Stack className="w-full px-5 font-semibold" mt={2} spacing={2}>
          <Stack
            direction="row"
            spacing={2}
            className="w-full items-center justify-between border-b border-gray-600 pb-2"
          ...
          <Stack
            direction="row"
            spacing={2}
            className="w-full items-center justify-between cursor-pointer pb-2"
            sx={{ color: theme.palette.text.primary }}
          >
